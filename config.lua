...
resetSystemEnabled = true -- enable/disable the reset system
resetSkills = true -- true = reset skills/magic level on reset, false = keep them
resetReductionPercentage = 0 -- XP reduction percentage per reset (e.g. 10 = 10%)    
...
experienceStages = {
	...
	{ minlevel = 391, maxlevel = 650, multiplier = 15 },
	{ minlevel = 651, multiplier = 5 }
}
